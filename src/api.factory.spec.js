describe('[Unit]: Testing api config provider', function() {
  ...
  describe('getEndpoint method', function() {
    ...
    it('should return http://api.creads-partners.com', inject(function(api) {
      expect(api.getEndpoint()).to.be.equal('http://api.creads-partners.com');
    }));
  ...
  describe('getVersion method', function() {
    ...
    it('should return 0.0.0', inject(function(api) {
      expect(api.getVersion()).to.be.equal('0.0.0');
    }));
